...
Source Database       : immovables

Target Server Type    : MYSQL
Target Server Version : 50637
File Encoding         : 65001

Date: 2018-07-07 12:25:31
*/
...
-- ----------------------------
-- Table structure for area_mechanism
-- ----------------------------
DROP TABLE IF EXISTS `area_mechanism`;
CREATE TABLE `area_mechanism` (
  `Id` int(11) NOT NULL,
...
-- ----------------------------
-- Records of area_mechanism
-- ----------------------------
INSERT INTO `area_mechanism` VALUES ('1', '1', '1');
...
CREATE TABLE `calendar` (
  ...
  `doubleCease` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `dictionaries` (
  `dId` int(11) NOT NULL,
  `dictionaries` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `dictionaries` VALUES ('1', 'area ', null, '字典表');
INSERT INTO `dictionaries` VALUES ('2', 'role    ', null, '角色表');
...
-- ----------------------------
INSERT INTO `jurisdiction` VALUES ('1', '系统访问');
INSERT INTO `jurisdiction` VALUES ('2', '审核访问');
INSERT INTO `jurisdiction` VALUES ('3', '增加');
INSERT INTO `jurisdiction` VALUES ('4', '删除');
INSERT INTO `jurisdiction` VALUES ('5', '修改');
INSERT INTO `jurisdiction` VALUES ('6', '审核');

-- ----------------------------
-- Table structure for jurisdiction_role
-- ----------------------------
DROP TABLE IF EXISTS `jurisdiction_role`;
CREATE TABLE `jurisdiction_role` (
  `j_rId` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of jurisdiction_role
-- ----------------------------
INSERT INTO `jurisdiction_role` VALUES ('8', '2', '0');
INSERT INTO `jurisdiction_role` VALUES ('94', '1', '3');
INSERT INTO `jurisdiction_role` VALUES ('95', '2', '3');
INSERT INTO `jurisdiction_role` VALUES ('96', '3', '3');
INSERT INTO `jurisdiction_role` VALUES ('97', '4', '3');
INSERT INTO `jurisdiction_role` VALUES ('98', '5', '3');
INSERT INTO `jurisdiction_role` VALUES ('99', '6', '3');
INSERT INTO `jurisdiction_role` VALUES ('101', '2', '1');
INSERT INTO `jurisdiction_role` VALUES ('102', '5', '1');
INSERT INTO `jurisdiction_role` VALUES ('103', '2', '2');
INSERT INTO `jurisdiction_role` VALUES ('104', '5', '2');
...
CREATE TABLE `mechanism` (
  `mId` int(11) NOT NULL,
  `mechanism` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `suId` int(11) DEFAULT NULL,
  `content` varchar(2550) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `mechanism` VALUES ('1', '综合办公室', null, '负责中心党总支会、主任办公会等有关会议的准备和记录，督促落实会议决定的落实；负责公文管理及督促实施工作，起草中心工作计划、总结等文稿，审核规范各类文稿；负责绩效和目标管理、质量管理工作；负责组织拟定中心工作制度和管理制度并组织实施；负责组织中心综合统计、分析；负责党务工作，协助党总支开展精神文明建设和干部职工思想教育及宣传工作；', '2018-07-05 20:26:48');
INSERT INTO `mechanism` VALUES ('2', '政策法规科', null, ' 负责中心对外各类法律事务；组织承担开展不动产登记相关政策、法规研究工作；承担不动产登记及相关法律法规、政策适用性研究工作；组织承担不动产登记、不动产权籍及土地权属等法律案件处理的事务性工作；落实不动产权属争议调处办法，协助有关部门开展不动产权属争议调查工作；承担上级交办的其它事项。', '2018-07-05 20:26:48');
INSERT INTO `mechanism` VALUES ('3', '技术信息（档案）科', null, '承担全市不动产登记信息化相关工作；承担中心城区范围内不动产登记、土地调查等档案的收集、整理、鉴定、保管、查询、应用等工作；承担内部信息网络、办公自动化系统、不动产登记门户网站管理、维护工作；负责中心技术管理工作，编制中心技术成果质量标准、检查验收办法等技术文件并组织实施；承担上级交办的其它事项。', '2018-07-05 20:26:48');
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('0', '普通角色', '普通用户', '2018-07-07 12:04:44');
INSERT INTO `role` VALUES ('1', '中级角色', '中级用户', '2018-07-07 12:04:46');
INSERT INTO `role` VALUES ('2', '高级角色', '高级用户', '2018-07-07 12:04:48');
INSERT INTO `role` VALUES ('3', '管理员角色', '管理员', '2018-07-07 12:04:49');
...
CREATE TABLE `user` (
  ...
  `userName` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '名字',
  `sex` int(11) DEFAULT NULL,
  `email` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `phone` varchar(120) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '手机号',
  `idCard` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '身份证号码',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '12345', '12345', '菁英', '1', '100@qq.com', '13254865780', '123456741235456580', '2018-06-30 15:52:00', '2');
INSERT INTO `user` VALUES ('2', 'admin', '12345', '管理员', '1', '5125@qq.com', '1231231231', '121011212012012000', '2018-07-02 00:37:55', '2');
INSERT INTO `user` VALUES ('47', '110', '123456', '小熊子', '1', '110@qq.com', '11011010010', '123132132132121111', '2018-07-07 11:44:32', '2');
INSERT INTO `user` VALUES ('48', '123456', '123456', '张飞', '1', '1100@qq.com', '13012354562', '125475223698524578', '2018-07-07 11:56:12', '2');
INSERT INTO `user` VALUES ('49', '120', '123456', '大飞', '1', '12132@qq.com', '12354565522', '123132121321232222', '2018-07-07 11:56:10', '2');
...
CREATE TABLE `user_role` (
  `u_rId` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `user_role` VALUES ('3', '46', '2');
INSERT INTO `user_role` VALUES ('73', '48', '2');
INSERT INTO `user_role` VALUES ('75', '47', '0');
INSERT INTO `user_role` VALUES ('79', '53', '0');
INSERT INTO `user_role` VALUES ('80', '54', '0');
INSERT INTO `user_role` VALUES ('81', '2', '3');
INSERT INTO `user_role` VALUES ('82', '48', '0');
INSERT INTO `user_role` VALUES ('83', '49', '0');
