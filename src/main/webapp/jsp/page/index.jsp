  ...
  <body>
	<div class="layout-admin">
		<header class="layout-header">
			<span class="header-logo">不动产系统</span> 
			<a class="header-menu-btn" href="javascript:;"><i class="icon-font">&#xe600;</i></a>
			<ul class="header-bar">
				<li class="header-bar-nav">
					<a href="javascript:;">${LOGIN_USER.userName }<i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
					<ul class="header-dropdown-menu">
						<li><a onclick="return confirm('确定切换用户？');" href="${pageContext.request.contextPath}/login">切换账户</a></li>
						<li><a onclick="return confirm('确定退出系统？');" href="${pageContext.request.contextPath}/login">退出</a></li>
					</ul>
				</li>
				<li class="header-bar-nav"> 
		...
		<div class="layout-footer">Copyright 不动产系统  by DR</div>
	</div>
