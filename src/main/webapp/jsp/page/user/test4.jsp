...
<div class="full">
	...
	<nav class="breadcrumb"><span class="glyphicon glyphicon-home"></span>
		    	...
		    	区域管理 <a class="btn btn-success navbar-right glyphicon glyphicon-refresh" href="javascript:location.replace(location.href);" title="刷新" ></a>
	</nav>
  	...
  	<div class="container-fluid text-center">
  	  <div class="row">
  	  	<div class="col-md-5"></div>
				<div class="col-md-2">
					<input type="text" class="form-control" style="width:220px" placeholder="区域名称" id="" name="">
				</div>
				<div class="col-md-1">
					<button type="submit" class="btn btn-primary" id="" name=""><span class="glyphicon glyphicon-user"></span>搜区域</button>
				</div>
  	  </div>
  	</div>
