...
<div class="full">
	...
	<nav class="breadcrumb"><span class="glyphicon glyphicon-home"></span>
		    首页 <span class="c-gray en">&gt;</span> 
		             ...
		             子系统设置<a class="btn btn-success navbar-right glyphicon glyphicon-refresh" href="javascript:location.replace(location.href);" title="刷新" ></a>
	</nav>
  	...
  	<div class="container-fluid text-center">
  	  <div class="row">
  	  	<div class="col-md-5"></div>
				<div class="col-md-2">
					<input type="text" class="form-control" style="width:180px" placeholder="输入系统名称" id="" name="">
				</div>
				<div class="col-md-1">
					<button type="submit" class="btn btn-primary" id="" name=""><span class="glyphicon glyphicon-user"></span>搜系统</button>
				</div>
  	  </div>
  	</div>
		...
		<div class="operation row">
			<div class="col-md-4"> 
				...
				<a href="javascript:;" onclick="admin_add('添加角色','admin-add.html','800','500')" class="btn btn-primary radius">
					<span class="glyphicon glyphicon-plus"></span>添加系统</a> 
			</div>
