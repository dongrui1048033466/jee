...
<div class="full">
	...
	<nav class="breadcrumb"><span class="glyphicon glyphicon-home"></span>
		             ...
		             节假日管理<a class="btn btn-success navbar-right glyphicon glyphicon-refresh" href="javascript:location.replace(location.href);" title="刷新" ></a>
	</nav>
  	...
  	<div class="container-fluid text-center">
  	  <div class="row">
  	  	<div class="col-md-5"></div>
				<div class="col-md-2">
					<input type="text" class="form-control" style="width:180px" placeholder="输入字典名称" id="" name="">
				</div>
				<div class="col-md-1">
					<button type="submit" class="btn btn-primary" id="" name=""><span class="glyphicon glyphicon-user"></span>搜字典</button>
				</div>
  	  </div>
  	</div>
		...
		<div class="operation row">
			<div class="col-md-4"> 
				...
				<a href="javascript:;" onclick="admin_add('添加角色','admin-add.html','800','500')" class="btn btn-primary radius">
					<span class="glyphicon glyphicon-plus"></span>添加字典</a>
			</div>
		...
		<table class="table table-border table-bordered table-bg">
			...
			<tbody>
				<tr class="text-center">
					...
					<td class="td-manage">
						<a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="添加下级字典"><i class="Hui-iconfont">&#xe631;</i></a>
				...
				<tr class="text-center">
					...
					<td class="td-manage">
						<a style="text-decoration:none" onClick="admin_start(this,'10001')" href="javascript:;" title="添加下级字典"><i class="Hui-iconfont">&#xe615;</i></a>
